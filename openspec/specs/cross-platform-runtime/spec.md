...
Provides a Node.js runtime module that manages the OmniRoute lifecycle, parallel tool initialization, and OpenCode launch without relying on bash or Unix-only utilities.
